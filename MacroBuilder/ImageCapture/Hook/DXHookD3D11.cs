...
using MacroBuilder.ImageCapture.Hook.DX11;
...
namespace MacroBuilder.ImageCapture.Hook
{
    ...
    internal class DXHookD3D11: BaseDXHook
    {
        ...
        global::SharpDX.Direct3D11.Device _device;
        SwapChain _swapChain;
        global::SharpDX.Windows.RenderForm _renderForm;
        Texture2D _resolvedRTShared;
        global::SharpDX.DXGI.KeyedMutex _resolvedRTSharedKeyedMutex;
        ...
        global::SharpDX.DXGI.KeyedMutex _resolvedRTKeyedMutex;
        global::SharpDX.DXGI.KeyedMutex _resolvedRTKeyedMutex_Dev2;
        #endregion
        ...
        public override void Hook()
        {
            ...
            if (_d3d11VTblAddresses == null)
            {
                ...
                _renderForm = ToDispose(new global::SharpDX.Windows.RenderForm());
                this.DebugMessage("Hook: Before device creation");
                global::SharpDX.Direct3D11.Device.CreateWithSwapChain(
                    DriverType.Hardware,
        ...
        delegate int DXGISwapChain_PresentDelegate(IntPtr swapChainPtr, int syncInterval, /* int */ global::SharpDX.DXGI.PresentFlags flags);
                        ...
                        ThreadPool.QueueUserWorkItem(new WaitCallback((o) =>
                        {
                            ...
                            lock (_lock)
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        db = _finalRT.Device.ImmediateContext.MapSubresource(_finalRT, 0, MapMode.Read, global::SharpDX.Direct3D11.MapFlags.DoNotWait);
                                        _finalRTMapped = true;
                                    }
                                    _queryIssued = false;
                                ...
                                catch (global::SharpDX.SharpDXException exc)
                                {
        ...
        global::SharpDX.WIC.ImagingFactory2 wicFactory;
