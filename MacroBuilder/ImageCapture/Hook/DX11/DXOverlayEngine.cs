...
namespace MacroBuilder.ImageCapture.Hook.DX11
{
    internal class DXOverlayEngine: Component
    {
        ...
        public bool Initialise(global::SharpDX.DXGI.SwapChain swapChain)
        {
        ...
        private void Begin()
        {
            //if (!DeferredContext)
            //{
                global::SharpDX.Mathematics.Interop.RawViewportF[] viewportf = { new ViewportF(0, 0, _renderTarget.Description.Width, _renderTarget.Description.Height, 0, 1) };
                _deviceContext.Rasterizer.SetViewports(viewportf);
                _deviceContext.OutputMerger.SetTargets(_renderTargetView);
            //}
        }
