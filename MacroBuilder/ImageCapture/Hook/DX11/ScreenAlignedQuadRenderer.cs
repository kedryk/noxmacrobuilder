...
";
        ...
        protected override void DoRender()
        {
            ...
            //using (var oldRenderTarget = context.OutputMerger.GetRenderTargets(1).FirstOrDefault())
            {
                ...
                // Set sampler
                global::SharpDX.Mathematics.Interop.RawViewportF[] viewportf = { new ViewportF(0, 0, RenderTarget.Description.Width, RenderTarget.Description.Height, 0, 1) };
                ...
                context.InputAssembler.PrimitiveTopology = global::SharpDX.Direct3D.PrimitiveTopology.TriangleStrip;
