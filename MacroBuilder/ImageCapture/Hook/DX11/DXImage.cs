    ...
    public class DXImage : Component
    {
        ...
        public bool Initialise(System.Drawing.Bitmap bitmap)
        {
            ...
            try
            {
                ...
                texDesc.MipLevels = 1;
                texDesc.ArraySize = 1;
                texDesc.Format = global::SharpDX.DXGI.Format.B8G8R8A8_UNorm;
                ...
                srvDesc.Format = global::SharpDX.DXGI.Format.B8G8R8A8_UNorm;
                srvDesc.Dimension = global::SharpDX.Direct3D.ShaderResourceViewDimension.Texture2D;
