...
namespace MacroBuilder.ImageCapture.Hook.DX11
{
    public class DXSprite : Component
    {
        ...
        global::SharpDX.Direct3D11.Buffer _VB;
        global::SharpDX.Direct3D11.Buffer _IB;
        int _texWidth;
        int _texHeight;
...
technique11 SpriteTech {
    pass P0 {
        ...
        public void DrawImage(int x, int y, float scale, float angle, System.Drawing.Color? color, DXImage image)
        {
            ...
            global::SharpDX.Mathematics.Interop.RawColor4 backupBlendFactor;
            int backupMask;
        ...
        public void EndBatch()
        {
            ...
            _deviceContext.InputAssembler.SetIndexBuffer(_IB, global::SharpDX.DXGI.Format.R16_UInt, 0);
            _deviceContext.InputAssembler.SetVertexBuffers(0, new[] { _VB }, new[] { stride }, new[] { offset });
            _deviceContext.InputAssembler.PrimitiveTopology = global::SharpDX.Direct3D.PrimitiveTopology.TriangleList;
