...
using MacroBuilder.ImageCapture.Hook.DX9;
...
namespace MacroBuilder.ImageCapture.Hook
{
    internal class DXHookD3D9: BaseDXHook
    {
        ...
        Query _query;
        global::SharpDX.Direct3D9.Font _font;
        bool _queryIssued;
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode, SetLastError = true)]
        unsafe delegate int Direct3D9Device_PresentDelegate(IntPtr devicePtr, global::SharpDX.Rectangle* pSourceRect, global::SharpDX.Rectangle* pDestRect, IntPtr hDestWindowOverride, IntPtr pDirtyRegion);

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode, SetLastError = true)]
        unsafe delegate int Direct3D9DeviceEx_PresentExDelegate(IntPtr devicePtr, global::SharpDX.Rectangle* pSourceRect, global::SharpDX.Rectangle* pDestRect, IntPtr hDestWindowOverride, IntPtr pDirtyRegion, Present dwFlags);
        ...
        // Used in the overlay
        unsafe int PresentExHook(IntPtr devicePtr, global::SharpDX.Rectangle* pSourceRect, global::SharpDX.Rectangle* pDestRect, IntPtr hDestWindowOverride, IntPtr pDirtyRegion, Present dwFlags)
        {
        ...
        unsafe int PresentHook(IntPtr devicePtr, global::SharpDX.Rectangle* pSourceRect, global::SharpDX.Rectangle* pDestRect, IntPtr hDestWindowOverride, IntPtr pDirtyRegion)
        {
            _isUsingPresent = true;
        ...
        void DoCaptureRenderTarget(Device device, string hook)
        {
            ...
            try
            {
                ...
                if (_queryIssued && _requestCopy != null && _query.GetData(out qryResult, false))
                {
                    ...
                    global::SharpDX.Rectangle rect;
                    global::SharpDX.DataRectangle lockedRect = LockRenderTarget(_renderTargetCopy, out rect);
        ...
        private global::SharpDX.DataRectangle LockRenderTarget(Surface _renderTargetCopy, out global::SharpDX.Rectangle rect)
        {
            if (_requestCopy.RegionToCapture.Height > 0 && _requestCopy.RegionToCapture.Width > 0)
            {
                rect = new global::SharpDX.Rectangle(_requestCopy.RegionToCapture.Left, _requestCopy.RegionToCapture.Top, _requestCopy.RegionToCapture.Width, _requestCopy.RegionToCapture.Height);
            }
            else
            {
                rect = new global::SharpDX.Rectangle(0, 0, _renderTargetCopy.Description.Width, _renderTargetCopy.Description.Height);
            }
