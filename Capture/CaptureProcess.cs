        ...
        public CaptureProcess(Process process, CaptureConfig config, CaptureInterface captureInterface)
        {
            ...
            try
            {
                ...
                RemoteHooking.Inject(
                    ...
                    @"D:\Projects\Katerra\Direct3DHook\bin\Capture.dll",//"Capture.dll", // 32-bit version (the same because AnyCPU) could use different assembly that links to 32-bit C++ helper dll
                    @"D:\Projects\Katerra\Direct3DHook\bin\Capture.dll", //"Capture.dll", // 64-bit version (the same because AnyCPU) could use different assembly that links to 64-bit C++ helper dll
